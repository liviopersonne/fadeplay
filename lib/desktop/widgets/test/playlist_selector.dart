...
class TestPlaylistSelector extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final folder2 = PlaylistFolder(
      name: "12",
      getContainingFolder: () => folder1,
    );
    final folder3 = PlaylistFolder(
      name: "13",
      getContainingFolder: () => folder1,
    );
    final folder4 = PlaylistFolder(name: "14");
    final folder5 = PlaylistFolder(
      name: "15",
      getContainingFolder: () => folder3,
    );
    final folder6 = PlaylistFolder(
      name: "16",
      getContainingFolder: () => folder1,
    );
    final allFolders = [folder1, folder2, folder3, folder4, folder5, folder6];

    final playlist1 = Playlist(name: "1", getContainingFolder: () => folder1);
    final playlist2 = Playlist(name: "2", getContainingFolder: () => folder2);
    final playlist3 = Playlist(name: "3", getContainingFolder: () => folder3);
    final playlist4 = Playlist(name: "4", getContainingFolder: () => folder4);
    final playlist5 = Playlist(name: "5", getContainingFolder: () => folder5);
    final playlist6 = Playlist(name: "6", getContainingFolder: () => folder6);
    final allPlaylists = [
      playlist1,
      playlist2,
      playlist3,
